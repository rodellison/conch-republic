package com.rodellison.conchrepublicskill.util;
...
import static com.rodellison.conchrepublicskill.util.StandardResponseUtil.*;
    ...
    public static Optional<Response> ProcessEventData (HandlerInput input, int sessionIndex, String currentSpeechText,
        ...
        if (supportsApl(input)) {
            ...
            try {
                ...
                ConchRepublicTemplateProperties.put("LayoutToUse", "Events");
                ...
                if (IntentName.contains("Artist")) {
                    ...
                    ConchRepublicTemplateProperties.put("EventImageUrl", SongkickArtistImageURLUpdated);
                }
                else
                    ConchRepublicTemplateProperties.put("EventImageUrl", "NA");

                ConchRepublicTemplateProperties.put("HintString", "Who is coming to the Mohawk");
            ...
            return input.getResponseBuilder()
                    .withSpeech(speechText)
                    .withReprompt(repromptSpeechText)
                    .withStandardCard(System.getenv("APP_TITLE"), prepForSimpleStandardCardText(speechText), myStandardCardImage)
                    .build();
        }
